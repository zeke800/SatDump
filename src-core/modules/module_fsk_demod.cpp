...
void FSKDemodModule::init()
{
    ...
    agc = std::make_shared<dsp::AGCBlock>(input_data_type == ModuleDataType::DATA_DSP_STREAM ? input_stream : file_source->output_stream, 0.0038e-3f, 1.0f, 0.5f / 32768.0f, 65536);
